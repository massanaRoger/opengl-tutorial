...
unsigned int linkFragmentsToProgram(unsigned int vertexShader, unsigned int fragmentShader) {
...
int main() {
    ...
    unsigned int shaderProgram = linkFragmentsToProgram(vertexShader, fragmentShader) ;

    unsigned int *VAOs = vertexInput();
